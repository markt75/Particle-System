...
//------------------------------------------------------------------
void Particle::increaseVelocity(){
	inc_dec_vel = true;
	vel *= 4;
}	

//------------------------------------------------------------------
void Particle::decreaseVelocity(){
	inc_dec_vel = true;
	vel /= 4;
}	

//------------------------------------------------------------------
void Particle::setKey(keyMode x){
	modeVal = x; 
}
...
// Second Particle constructor for mode draw
// Needs parameters to make particles appear in mouse possition.
